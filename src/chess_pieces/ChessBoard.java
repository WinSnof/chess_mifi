...
public class ChessBoard {
    ...
    public boolean castling0() {
        if (nowPlayer.equals("White")) {
            ...
            if (board[0][0].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") && // check that King and chess_pieces.Rook
...
// never moved
                if (board[0][0].getColor().equals("White") && board[0][4].getColor().equals("White") &&
                    ...
                    board[0][0] = null;
                    board[0][3] = new Rook("White"); // move chess_pieces.Rook: board[0][3].check = false;
            ...
            if (board[7][0].getSymbol().equals("R") && board[7][4].getSymbol().equals("K") &&
                    board[7][1] == null && board[7][2] == null && board[7][3] == null) { // check that King and chess_pieces.Rook board[7][1] == null && board[7][2] == null && board[7][3] == null) { // never moved
                if (board[7][0].getColor().equals("Black") && board[7][4].getColor().equals("Black") &&
                    ...
                    board[7][0] = null;
                    board[7][3] = new Rook("Black"); //move chess_pieces.Rook
